...
class EcPlot:
    ...
    def plot_circle(self, x_values, y_values, legend_label="") -> None:
        self.fig.circle(
            x_values, y_values, size=2, legend_label=legend_label, color=next(self.colors)
        )

    def plot_line(self, x_values, y_values) -> None:
        self.fig.line(x_values, y_values)

    def add_second_axis(self, y_range_name: str, range_min, range_max, axis_label: str) -> None:
    ...
    def plot_second_axis(self, x_values, y_values, legend_label=""):
        self.fig.circle(x_values, y_values, size=2, legend_label=legend_label, color=next(self.colors), y_range_name=self.y_range_name)
